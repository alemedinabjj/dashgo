...
export const Pagination = ({ totalCountOfRegisters, registersPerPage = 10, currentPage = 1, onPageChange }: PaginationProps) => {
  ...
  return (
    <Stack direction={["column", "row"]} mt="8" justify="space-between" align="center" spacing="6">
      ...
      <Stack direction="row" spacing="2" display="flex" alignItems="flex-end">
